...
public class AuthenticationService {
    ...
    private String buildEmail2(User user,String link)
    {
        return "<!DOCTYPE html>\n" +
                ...
                "        <h3>Thank you for registering to our web site. Please click on the below link to activate your account:</h3>\n" +
    ...
    private String buildEmailMod(String token,User user)
    {
        return "<!DOCTYPE html>\n" +
                ...
                "  <body>\n" +
                "    <div class=\"container\">\n" +
                "      <img src=\"https://i.ibb.co/nkrBqck/334886508-513260607680644-3515218608247778867-n.png\" alt=\"offre logo\" padding-left=\"60%\" height=\"70px\" width=\"130px\">\n" +
                "<br>     \n" +
                " <div class=\"text\">\n" +
